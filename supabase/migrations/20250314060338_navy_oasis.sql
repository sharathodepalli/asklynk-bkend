/*
  # Fix Timestamp Handling in Messages Table

  1. Changes
    - Fix timestamp handling for delivered_at and read_at columns
    - Properly handle NULL and empty string values
    - Ensure data integrity during migration
    - Preserve existing relationships and constraints

  2. Security
    - Maintain existing RLS policies
    - Preserve message privacy and user relationships
*/
